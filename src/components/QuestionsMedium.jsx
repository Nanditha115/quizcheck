...
const QuestionsMedium = ({ data, onAnswerUpdate, numberOfQuestions, activeQuestion, onSetActiveQuestion, onSetStep, repeatedQues, setRepeatedQues }) => {
                    ...
                    <div className="control" ref={radiosWrapper}>
                        {data.choices.map((choice, i) => (
                            <label className="radio has-background-light" key={i}>
                                <input type="radio" name="answer" id = "rad" value={choice} onChange={changeHandler} onClick={nextClickHandler} />
                                {choice}
                            </label>
                        ))}
                    </div>
